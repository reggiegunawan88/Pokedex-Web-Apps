...
function PokemonList() {
  return (
    <div className="flex flex-col gap-y-7 tablet:flex-row-reverse tablet:justify-center tablet:mt-20 tablet:gap-x-15">
      {/* pokemon thumbnail */}
      ...
      {/* pokemon list grid */}
      <div className="tablet:bg-white tablet:rounded-lg tablet:shadow-lg tablet:p-7 tablet:mx-5 tablet:h-110">
